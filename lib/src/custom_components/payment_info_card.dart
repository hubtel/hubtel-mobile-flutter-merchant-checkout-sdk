...
import 'package:unified_checkout_sdk/src/custom_components/payment_info_horizontal.dart';
import 'package:unified_checkout_sdk/src/custom_components/zigzag_clipper.dart';
...
class PaymentInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: const EdgeInsets.symmetric(horizontal: Dimens.paddingLarge),
